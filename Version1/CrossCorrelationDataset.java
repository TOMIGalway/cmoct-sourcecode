...
public class CrossCorrelationDataset
{
	...
	public void setData(ImageProducer data) throws IOException
	{
		...
		this.sizeZ = inputData.getImageCount() / getScanNumber();
	...
	/*
	 * This methods has been added as part of the new functionality to
	 * process multiple scans taken at the same location.
	 */
	...
	public void setNumberOfScans(int numberOfScansInEachLocation)
	{
		this.scanNumber = numberOfScansInEachLocation;
	}
