...
public class FileFinderTool
{
	...
	File directory, FilenameFilter filter, boolean recurse)
	{
		...
		for (File entry : entries)
		{
			// Java4: for (int f = 0; f <
			// files.length; f++) {
			// Java4: File entry = (File)
			// files[f];

			// If there is no filter or the filter
			// accepts the
			// file / directory, add it to the
			// list
