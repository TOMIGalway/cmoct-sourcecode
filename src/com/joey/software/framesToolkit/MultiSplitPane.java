...
import com.joey.software.framesToolkit.MultiSplitLayout.Divider;
import com.joey.software.framesToolkit.MultiSplitLayout.Node;
...
public class MultiSplitPane extends JPanel
{
	...
	private void startDrag(int mx, int my)
	{
		...
		if (divider != null)
		{
			...
			} else
			{
				...
				oldFloatingDividers = getMultiSplitLayout()
						.getFloatingDividers();
	...
	private void updateCursor(int x, int y, boolean show)
	{
		...
		if (show)
		{
			MultiSplitLayout.Divider divider = getMultiSplitLayout()
					.dividerAt(x, y);
			if (divider != null)
			{
