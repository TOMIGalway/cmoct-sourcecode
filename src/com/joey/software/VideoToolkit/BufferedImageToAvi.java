 ...
 */
public class BufferedImageToAvi
{
	...
	public static void main(String input[]) throws IOException
	{
		...
		BufferedImage[] data = new BufferedImage[total];
		for (int i = 0; i < total; i++)
		{
			data[i] = ImageOperations.getBi(wide, high);
			ImageOperations.fillWithRandomColors(data[i]);
		}

		BufferedImageToAvi output = new BufferedImageToAvi();

		output.writeImage("test.avi", "c:\\test\\", 10, true, data);
	}

	public void run(BufferedImage... images) throws IOException
	{

		writeImage("", "", 50, true, images);

	}

	public void writeImage(String fileName, String fileDir, int frameRate, boolean color, BufferedImage... imp)
			throws IOException
	{
		...
		tDim = 1;
		zDim = imp.length;// getStackSize();
		yDim = imp[0].getHeight();
		xDim = imp[0].getWidth();
		xPad = 0;
		xMod = xDim % 4;
		if (xMod != 0)
	...
	public void writeByteFrame(BufferedImage img) throws IOException
	...
	public void writeRGBFrame(BufferedImage img) throws IOException
	{
