 ...
 * com.sun.j3d.utils.behaviors.mouse.MouseRotate class which filters the mouse
 * events to only process the last mouse event.
 * 
			...
			if (wakeup instanceof WakeupOnAWTEvent)
			{
				...
				if (lastDragEvent != null)
				{
					...
					if (!reset)
					{
						...
						if (callback != null)
							callback
									.transformChanged(MouseBehaviorCallback.TRANSLATE, currXform);
