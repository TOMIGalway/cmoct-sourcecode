 ...
 * <p>
 * Provide two endpoints, and this will do the necessary transformations on the
 * Java3D Cylinder class for you, returning the Cylinder in a BranchGroup.
 * 
 * @author Scott Teresi, March 1999
 * 
 */
...
public class CylinderCreator
{
	...
	public void setRadialSegs(int seg)
	{
		radSeg = seg;
	}

	public void setAxialSegs(int seg)
	{
		axialSeg = seg;
	}
	 ...
	 * @param b
	 *            coordinates of the base of the cylinder.
	 * @param a
	 *            coordinates of the top of the cylinder.
	 * @param radius
	...
	public BranchGroup create(Point3d b, Point3d a, double radius, Appearance cylApp)
	{
		...
		Cylinder cyl = new Cylinder((float) radius, (float) height,
				Primitive.GENERATE_NORMALS, radSeg, axialSeg, cylApp);
		tg.addChild(cyl);
