		...
		ActionListener
{
	...
	AnnotationsEditor(VolRend volRend)
	{
		...
		AttrComponent px = new JPanelToggle(this, boxPanel,
				volRend.plusXBoxAttr);
		AttrComponent py = new JPanelToggle(this, boxPanel,
				volRend.plusYBoxAttr);
		AttrComponent pz = new JPanelToggle(this, boxPanel,
				volRend.plusZBoxAttr);
