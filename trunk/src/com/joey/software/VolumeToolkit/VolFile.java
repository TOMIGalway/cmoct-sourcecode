...
public class VolFile
{
	...
	public float slicePosX = 1;

	public float slicePosY = 1;

	public float slicePosZ = 1;

	public boolean useXSlice = false;

	public boolean useYSlice = false;

	public boolean useZSlice = false;
	 ...
	 */
	public VolFile(String volumeFile) throws java.io.IOException
	{
		try
		{
			System.out.println("Loading : " + volumeFile);
			file = new DataInputStream(new FileInputStream(volumeFile));
			...
			for (int z = 0; z < zDim; z++)
			{
				for (int y = 0; y < yDim; y++)
				{
					...
					for (int x = 0; x < xDim; x++)
					{
						...
						fileValue -= minVal;
						double scaleValue = (fileValue - windowBase)
								/ windowWidth;
						if (scaleValue > 1.0)
						{
							scaleValue = 1.0;
